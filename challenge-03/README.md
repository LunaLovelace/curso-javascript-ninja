...
var pessoa = { nome: 'A', sobrenome: 'B', sexo: 'F', idade: 18, altura: 1,40, peso: 50, andando: false, caminhouQuantosMetros: 0};
...
pessoa.nomeCompleto(); // Eae! me chamo A B. Brincadeira! Na verdade isso é só um teste por tanto meu nome não importa...
...
pessoa.mostrarIdade(); //Puts, eu to mó veia. Tenho 18 anos. Sim essa é a minha idade mesmo, não to brincando...
...
pessoa.mostrarPeso(); //Peso 50Kg. Quem dera ;-;
...
pessoa.mostrarAltura(); //Minha altura seria 1,40m. Isso se eu tivesse uns 14 anos...
...
pessoa.mostrarIdade(); //Puts, eu to mó veia. Tenho 21 anos. Sim essa é a minha idade mesmo, não to brincando...
